...
<modelo_keywords>máximo de keywords e sinônimos relevantes separados por espaço</modelo_keywords>
<modelo>nome do modelo do produto para ficha técnica ML, ex: "Legging Fitness Cintura Alta", "Cropped Academia Dry Fit"</modelo>
...
Siga rigorosamente as regras do system prompt e responda apenas com as tags XML."""
    ...
    def _parse_output(self, raw: str) -> dict:
        ...
        modelo_keywords = _extract_tag(raw, "modelo_keywords")
        ...
        if not all([titulo, palavras_chave, modelo_keywords, modelo, esportes_raw, descricao, skus_raw, tipo_manga, tipo_gola]):
            return {"raw": raw}
        ...
        return {
            ...
            "modelo_keywords": modelo_keywords,
            "modelo": modelo,
